...
%         'ReportMarkerLocations' - Flag (true or ralse) indicating whether
%                   or not to report model marker locations relative to 
...
V.InverseKinematicsTool.report_marker_locations = ReportMarkerLocations;
if isempty(OutputFile)
